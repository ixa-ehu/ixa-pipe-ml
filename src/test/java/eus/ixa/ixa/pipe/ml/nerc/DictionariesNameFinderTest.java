...
public class DictionariesNameFinderTest {
  ...
  public static void setUpClass() throws IOException {
    ...
    final File dictsDir = Files.createTempDirectory("dicts").toFile();
    Files.copy(
  ...
  public void oneOccurrence() throws IOException {
    final Span[] spans = finder.nercToSpansExact(new String[] { "Achilles" });
    assertEquals(1, spans.length);
  }

  @Test
  public void twoOccurrences() throws IOException {
    final Span[] spans = finder.nercToSpansExact(
