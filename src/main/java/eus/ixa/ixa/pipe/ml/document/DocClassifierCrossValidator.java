...
public class DocClassifierCrossValidator {
  ...
  public DocClassifierCrossValidator(String languageCode, TrainingParameters mlParams,
      DocumentClassifierFactory factory, DocumentClassifierEvaluationMonitor ... listeners) {
