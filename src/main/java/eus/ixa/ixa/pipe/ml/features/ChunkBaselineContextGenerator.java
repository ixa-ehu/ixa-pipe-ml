...
public class ChunkBaselineContextGenerator extends CustomFeatureGenerator implements ArtifactToSerializerMapper {
  ...
  public void createFeatures(List<String> features, String[] tokens, int index,
    ...
    if (index < 2) {
      ...
      t_2 = "t_2=" + currentTags[index - 2].getType();
      p_2 = "p_2" + previousOutcomes[index - 2];
    }
    if (index < 1) {
      w_1 = "w_1=bos";
      t_1 = "t_1=bos";
      ...
      t_1 = "t_1=" + currentTags[index - 1].getType();
    ...
    if (index + 1 >= tokens.length) {
      ...
      t1 = "t1=" + currentTags[index + 1].getType();
    }
    if (index + 2 >= tokens.length) {
      ...
      t2 = "t2=" + currentTags[index + 2].getType();
    }
    //add word features
    features.add(w_2);
    features.add(w_1);
