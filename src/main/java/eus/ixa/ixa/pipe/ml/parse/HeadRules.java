...
public interface HeadRules {
   ...
   *
   * @param constituents
   *          The constituents which make up a constituent of the specified
   *          type.
   * @param type
   *          The type of a constituent which is made up of the specified
   *          constituents.
  ...
  /**
   * Returns the set of punctuation tags. Attachment decisions for these tags
   * will not be modeled.
   *
